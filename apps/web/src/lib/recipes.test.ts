...
const safe: MealRecommendations = { dishes: [
  { name: "菠菜炒蛋", uses: [{ batchId: "b0f7a6b4-1250-4e8e-8af9-7300c7378b86", quantity: 1, unit: "袋" }], missingIngredients: ["鸡蛋"], reason: "优先消耗临期菠菜" },
  { name: "菠菜汤", uses: [{ batchId: "b0f7a6b4-1250-4e8e-8af9-7300c7378b86", quantity: 1, unit: "袋" }], missingIngredients: ["高汤"], reason: "简单快速" },
  { name: "清炒菠菜", uses: [{ batchId: "b0f7a6b4-1250-4e8e-8af9-7300c7378b86", quantity: 1, unit: "袋" }], missingIngredients: ["蒜"], reason: "适合已开封食材" },
] };
